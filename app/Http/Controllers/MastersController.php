...
class MastersController extends Controller
{
   ...
   //**employee-master** 
	...
	{
		DB::statement("call usp_empolyeemaster_insert(?,?,?,?,?,?,?,?,?,?,?,?,?,?)",array($req->empname,$req->empcode,$req->companyname,$req->email,$req->address,$req->dob,$req->mobile,$req->department,$req->reporting_authority,$req->date_of_joining,$req->designation,$req->band,$req->ctc,$req->variable));
